...
package com.example.poketmontest.ui.adapter
...
import com.example.poketmontest.databinding.ItemPokemonBinding
...
class PokemonAdapter : ListAdapter<Pokemon,PokemonAdapter.PokemonViewHolder>(diffUtil) {
  ...
  override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PokemonViewHolder {
    ...
    var itemPokemonBinding:ItemPokemonBinding = ItemPokemonBinding.inflate(layoutInflater,parent,false)
